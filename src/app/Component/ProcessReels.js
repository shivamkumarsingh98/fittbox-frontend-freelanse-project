    ...
    <section className="w-full bg-white overflow-hidden">
      ...
      <div className="relative w-full">
        ...
        <svg
          viewBox="0 0 1440 80"
          preserveAspectRatio="none"
          className="w-full h-12 sm:h-16 md:h-20 fill-orange-600 block"
        >
          <path d="M0,40 C360,80 1080,0 1440,40 L1440,80 L0,80 Z" />
        </svg>

        {/* Cards grid — sits on top of the band */}
        <div className="bg-orange-600 w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
              ...
              return (
                <div
                  ...
                  className={`
                    ...
                    w-[72vw] sm:w-auto
                    aspect-[9/16]
                    bg-neutral-900 rounded-2xl overflow-hidden shadow-2xl
                    cursor-pointer
                    transition-transform duration-300
                    hover:scale-105 hover:-translate-y-2 hover:rotate-0
                    ${index % 2 === 0 ? "lg:-rotate-[2.5deg]" : "lg:rotate-[2.5deg]"}
                  `}
                  onMouseEnter={() => handleMouseEnter(reel.id)}
                  onMouseLeave={() => handleMouseLeave(reel.id)}
                  onClick={() => handlePlayToggle(reel.id)}
                >
                  ...
                  <div className="absolute top-3 left-3 z-20">
                    <span
                      className={`text-[10px] font-extrabold text-white px-2.5 py-1 rounded-md tracking-wider ${reel.tagColor}`}
                    >
                      {reel.tag}
                    </span>
                  </div>
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-4 z-10 text-white">
                    ...
                    <div className="w-full bg-white/20 h-[3px] rounded-full overflow-hidden mt-3">
                      <div
                        className={`bg-red-500 h-full rounded-full transition-all duration-[3000ms] ${
          ...
          {/* Mobile scroll hint */}
          <p className="text-center text-white/60 text-xs mt-4 sm:hidden">
            ← Swipe to see more →
          </p>
        </div>
        ...
        <svg
          viewBox="0 0 1440 80"
          preserveAspectRatio="none"
          className="w-full h-12 sm:h-16 md:h-20 fill-orange-600 block rotate-180"
        >
          <path d="M0,40 C360,80 1080,0 1440,40 L1440,80 L0,80 Z" />
        </svg>
      </div>
